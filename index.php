...
// require_once __DIR__ . '/path/to/your/Connection.php';

// Get a database connection instance
// $databaseConnection = \YourNamespace\DatabaseConnection::getInstance();
// $pdo = $databaseConnection->getConnection();

// Your application code starts here...

// use App\Controllers\YourController;  // Adjust the namespace based on your project structure

// Example usage of a controller
// $controller = new YourController($pdo); // Pass the PDO instance to your controller
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="View/auth/login.php" style="color: #C66D28;" >log in</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="Public/img/books/book1.jpg" title="Project Name">
                            <img class="img-fluid" src="Public/img/books/book1.jpg" alt="..." />
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="Public/img/books/book2.jpg" title="Project Name">
                            <img class="img-fluid" src="Public/img/books/book2.jpg" alt="..." />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="Public/img/books/book3.jpg" title="Project Name">
                            <img class="img-fluid" src="Public/img/books/book3.jpg" alt="..." />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="Public/img/books/book4.jpg" title="Project Name">
                            <img class="img-fluid" src="Public/img/books/book4.jpg" alt="..." />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Romance</div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="Public/img/books/book5.jpg" title="Project Name">
                            <img class="img-fluid" src="Public/img/books/book5.jpg" alt="..." />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Romance</div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="Public/img/books/book6.jpg" title="Project Name">
                            <img class="img-fluid" src="Public/img/books/book6.jpg" alt="..." />
